...
angular.module('schemaForm').controller('dynamicSelectController', ['$scope', '$http', '$timeout', 'httpClient',function ($scope, $http, $timeout, httpClient) {
