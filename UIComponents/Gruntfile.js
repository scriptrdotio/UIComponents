  ...
  grunt.initConfig({
	    ...
	    uglify:{
			dist: {
				files: {
					...
					'grunt/js/dashboardBuilder_resources.min.js': ['build/javascript/dashboardBuilder_resources.js'],
					
					'grunt/js/template_resources.min.js': ['build/javascript/template_resources.js']
		...
		cssmin: {
		    css:{
				...
				dest: 'grunt/css/components.min.css'
		    }
		},
