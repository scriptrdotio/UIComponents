	         ...
	         ngAnnotate : {
	            ...
	            app : {
		            files : {
		               ...
		               'concat/min-safe/displayBox.js' : [ 'dashboard/frontend/UIComponents/Components/message/displayBox.js' ],
		               'concat/min-safe/message.js' : [ 'dashboard/frontend/UIComponents/Components/message/message.js' ],
		               'concat/min-safe/displayBox.js' : [ 'dashboard/frontend/UIComponents/Components/message/displayBox.js' ],
		               'concat/min-safe/message.js' : [ 'dashboard/frontend/UIComponents/Components/message/message.js' ],
