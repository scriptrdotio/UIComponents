...
| ------------- |:-------------:|:-------------:|:-------------:|:----------|
  ...
  custom-goals     | null	 | Array of goals and goal line color, size, label ex: [{"goal-line-colors":"#f0f0f0","goals":1, "label":"test", size: "1", "labelFont":"12px 'Barlow', sans-serif"}]. | array | NO
  custom-events     | null	 |  Array of events and event line color ex: [{"event-line-colors":"#cccccc","events":"20-03-2008"}]. | array | NO
   custom-ranges     | null	 | Array of ranges to be colored as horizontal rectangles on the chart, with range an array of min and max value on the y axis ex: [{"color":"#3EC9A4", "range": [0, 2], "opacity":0.6},{"color":"#3EC65E", "range": [2, 3], "opacity":0.6},{"color":"#FFFB64", "range": [3, 4], "opacity":0.6},{"color":"#F98F53", "range": [4,5.0], "opacity":0.6},{"color":"#FF4D4D",  "range": [5.0, 1000],  "opacity":0.6}] | array | NO
