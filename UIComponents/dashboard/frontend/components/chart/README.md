...
| ------------- |:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
  ...
  xkey     | 'y'	 | The name of the data record attribute that contains x-values. | Line, Areea & Bar | *  |  * | 
  ykeys       | ["a"]    | // A list of names of data record attributes that contain y-values. | Line, Areea & Bar | *  |  * | 
