...
c.consumeData(a)})}):"https"==d&&c.api&&a.get(c.api,c.apiParams).then(function(a,b){"function"==typeof c.onFormatData()&&(a=c.onFormatData()(a)),c.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){this.gaugeValue=a}}]});